...
gam_adjust = function(data) {
    ...
    # The spline fit was not used downstream, and can fail when Statistics
    # Denmark returns a group with missing, duplicated, or constant dates.
    # Keep the transformation robust to those API responses.
