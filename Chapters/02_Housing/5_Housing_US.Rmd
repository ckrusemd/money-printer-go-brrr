...
```{r}
df_housing_us = do.call("rbind",lapply(c("MORTGAGE30US","CSUSHPINSA","NASDAQCOM","WILL5000INDFC","WM2NS","M2V","CPIAUCSL","MSACSR","ACTLISCOUUS","PERMIT","COMPUTSA","UNRATE"),function(series) { 
...
df_CSUSHPINSA = df_housing_us %>% 
  crossing(data.frame(peak=c("2006","2022"),
